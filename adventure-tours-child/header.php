        ...
        <div class="header__content-wrap">
            <div class="row">
                <div class="col-md-12 header__content">
                    ...
                    <?php endif; ?>
					<a class="home_url" href="<?=home_url()?>"><i class="td-house-1"></i></a>
                    <div class="clearfix"></div>
                </div><!-- .header__content -->
            </div>
        </div><!-- .header__content-wrap -->
        <div class="header__continents">
            <div class="row">
				<?php wp_nav_menu(array(
					'theme_location' => 'countries_menu',
					'container' => 'ul',
					'menu_class' => 'col-md-12 continents__links countries-nav',
					'menu_id' => 'countries_menu',
					'depth' => 3,
				)); ?>
                <div class="clearfix"></div>
            </div>
        </div><!-- .header__continents -->
    </div><!-- .container -->
</header>
